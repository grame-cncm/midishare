...
NAME
      MidiGetIndDriver -- a very simple MidiShare tool

SYNOPSIS
      MidiGetIndDriver <index>

DESCRIPTION
       returns the reference of number of a driver from is order number.
      <index> should be a number between 1 and MidiCountDrivers
...
int main (int argc, char *argv[])
{
	...
	ref = MidiGetIndDriver (GetIndex (argv[1]));
