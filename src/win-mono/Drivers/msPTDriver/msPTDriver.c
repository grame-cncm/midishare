...
typedef struct {
	...
	long			dynamic;
    long 			old_bendlength;
	long			old_vol;  // valeur du dernier volume envoye
	long			old_bend; // valeur du dernier bend envoye
	long			numInput;
	long			numOutput;
...
/* -----------------------------------------------------------------------------*/
static CALLBACK FlushReceivedEvents(short r){MidiFlushEvs (r);}

/* -----------------------------------------------------------------------------*/
/* Driver required callbacks                                                    */
/* -----------------------------------------------------------------------------*/
static CALLBACK msWakeUp(short r)
{
...
/* -----------------------------------------------------------------------------*/
static CALLBACK msSleep(short r)
{
	AudioSleep();
}
