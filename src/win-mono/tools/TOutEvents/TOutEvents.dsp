...
!MESSAGE 
!MESSAGE NMAKE /f "TOutEvents.mak".
!MESSAGE 
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib /nologo /subsystem:console /machine:I386 /out:"../TOutEvents.exe"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib /nologo /subsystem:console /debug /machine:I386 /out:"TOutEvents.exe" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "TOutEvents - Win32 Release"
