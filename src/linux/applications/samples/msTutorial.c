...
void test4 ()
{
        ...
        ourRefNum = MidiOpen("Linux_Tutorial");
        if (ourRefNum > 0) 
...
//   2 : reference number  1, name : 'Linux_Tutorial'
// -------------------------------------
...
//===================================================================================
// test 7 : search for a client application with name "Linux Tutorial"
//===================================================================================
...
void test7 ()
{
        printf("\n\n<TEST 7> search the reference number of 'Linux Tutorial'\n");
        DebugStr ("--> use g or G to search the reference number of 'Linux Tutorial' and go to the next test\n");

        printf("Reference number of '%#s' : %d\n", "Linux Tutorial", MidiGetNamedAppl("Linux_Tutorial"));
}
...
//===================================================================================
// test 9 : change the name of client application "Linux Tutorial" to "MidiShare Tutorial"
//===================================================================================
...
void test9 ()
{
        ...
        MidiSetName(MidiGetNamedAppl("Linux_Tutorial"), "MidiShare_Tutorial");
        listOfAppl ();
}
