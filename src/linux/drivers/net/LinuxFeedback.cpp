...
void LinuxFeedback::Lookup (strPtr name)
{
...
//_________________________________________________________________________________
void LinuxFeedback::Connecting (char * name)
{
...
//_________________________________________________________________________________
void LinuxFeedback::CheckLatency (char * name) 
{ 
...
//_________________________________________________________________________________
void LinuxFeedback::CloseReport (TMidiRemote * remote, CnxReportPtr report)
{
...
//_________________________________________________________________________________
void LinuxFeedback::Complete (TMidiRemote * remote) 
{ 
...
//_________________________________________________________________________________
void LinuxFeedback::Remove (TMidiRemote * remote)
{
...
//_________________________________________________________________________________
void LinuxFeedback::CnxRefused (strPtr host, short reason)
{
	char *str;
	switch (reason) {
...
//_________________________________________________________________________________
void LinuxFeedback::Failed (short reason)
{
}
