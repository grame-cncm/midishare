...
EXPORT_SYMBOL(MSSetLink);
EXPORT_SYMBOL(MSGetDate);
EXPORT_SYMBOL(MSSetDate);
EXPORT_SYMBOL(MSGetRefNum);
EXPORT_SYMBOL(MSSetRefNum);
EXPORT_SYMBOL(MSGetType);
EXPORT_SYMBOL(MSSetType);
EXPORT_SYMBOL(MSGetChan);
EXPORT_SYMBOL(MSSetChan);
EXPORT_SYMBOL(MSGetPort);
EXPORT_SYMBOL(MSSetPort);
EXPORT_SYMBOL(MSGetData0);
EXPORT_SYMBOL(MSGetData1);
EXPORT_SYMBOL(MSGetData2);
EXPORT_SYMBOL(MSGetData3);
EXPORT_SYMBOL(MSSetData0);
EXPORT_SYMBOL(MSSetData1);
EXPORT_SYMBOL(MSSetData2);
EXPORT_SYMBOL(MSSetData3);
EXPORT_SYMBOL(MSGetFirstEv);
EXPORT_SYMBOL(MSSetFirstEv);
EXPORT_SYMBOL(MSGetLastEv);
EXPORT_SYMBOL(MSSetLastEv);
